...
public class FindLctResult {
    ...
    // 자동차 무료우선 -> 최소비용
    public static void findCarFree(final String startName, final int startLabel, final String endName, final int endLabel, final String urlString, final Pathway pathway) {
        Thread thread = new Thread() {
            ...
            public void run() {
                try {
                    ...
                    pathway.insertSpot(spot1, spot2);
    ...
    //자동차 최단시간
    public static void findCarShort(final String startName, final int startLabel, final String endName, final int endLabel, final String urlString, final Pathway pathway) {
        Thread thread = new Thread() {
            @Override
            public void run() {
                try {
                   ...
                   // LogManager.printLog("FREE result: " + builder.toString());
                    ...
                    /* Spot 만들기 */
                    Spot spot1 = new Spot(startLabel, startName);
                    Spot spot2 = new Spot(endLabel, endName, carSCost, carSTaxi, carFTime);
    ...
    //대중교통 최단시간
    public static void findBusShort(final String startName, final int startLabel, final String endName, final int endLabel, final String urlString, final Pathway pathway) {
        Thread thread = new Thread() {
            @Override
            public void run() {
                try {
